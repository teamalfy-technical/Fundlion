                ...
                <div class="row h-100 mb-50 align-items-center">
                    ...
                    <div class="card" style="border-color:#fff;width: 26rem;">
                        <div class="card-body text-center">
                            ...
                            <h5>Client Login</h5>
                            <br>
                            <form method="POST" action="{{ route('clients.login') }}" role="form">
                                @csrf
                                ...
                                <div class="form-group text-center">
                                    <a href="{{ route('clients.password.request') }}" class="text-dark" style="font-size: 14px;font-weight:600">Forgot password?</a>
                                </div>
                            </form>
                            <div class="form-group text-center mt-5">
                                <p>If you don't have an account <a href="{{route('clients.register')}}" style="font-size: 14px;font-weight: 500; color: #d53d00;">click here to sign up</a></p>
                            </div>
                        </div>
                    </div>
