...
$faq_type = DB::select('SELECT DISTINCT `type` FROM `fl_cms_faq`');
// echo '<pre>';
// print_r($faq_type);
// echo '</pre>';
// die(); 
            ...
            <div class="layout-content-body container" style="background-color: #e0e0e0;font-weight: 700; min-height:100vh;">
                ...
                <div class="row">
                    <div class="col-lg-10 col-lg-offset-1">
                        <h2 style="color: #000000;font-weight: 900;">Add <span style="font-weight: 100;">FAQ Item</span></h2>
                    </div>
                </div>
                ...
                <div class="row ">
                    <div class="col-lg-6 col-lg-offset-1">
                        ...
                        <form action="{{route('users.cms.add_faq_save')}}" method="post" role="form" enctype="multipart/form-data">
                         @csrf
<!--                             <div class="form-group">
                                <label for="formGroupExampleInput">Type</label>
                                <input type="text" class="form-control" id="formGroupExampleInput" placeholder="Example input"  name="type" required="">
                            </div> -->
...
<!--                                     <option value="1" >1</option>
                            ...
                            <div class="form-group">
                                ...
                                <textarea  style="height: 200px;" class="form-control" id="description" placeholder="Another input" name="text"> </textarea>
                                                                    @error('text')
