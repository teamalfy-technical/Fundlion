            ...
            <div class="layout-content-body container" style="background-color: #e0e0e0;font-weight: 700; min-height:100vh;">
                ...
                <div class="row">
                    <div class="col-lg-10 col-lg-offset-1">
                        <h2 style="color: #000000;font-weight: 900;">Add <span style="font-weight: 100;"> Lending Partner Item</span></h2>
                    </div>
                </div>
                ...
                <div class="row ">
                    <div class="col-lg-6 col-lg-offset-1">
                        ...
                        <form action="{{route('users.cms.new_lending_patners_save')}}" method="post" role="form" enctype="multipart/form-data">
                         @csrf
