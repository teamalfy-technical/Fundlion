                ...
                <div class="row">
                    <div class="col-lg-12 col-lg-offset-1">
                        ...
                        <br>
                            ...
                            <form action="{{route('users.cms.delete_careerp')}}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="modal-body">
                                    ...
                                    <button type="button" class="btn btn-outline-secondary"><a href="{{route('users.cms.career')}}" style="color: #000;" >{{__("No")}}</a></button>
                                    </div>
                                </div>
