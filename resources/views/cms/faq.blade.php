            ...
            <div class="layout-content-body" style="background-color: #e0e0e0;font-weight: 700;height: unset;">
                ...
                <div class="row gutter-xs">
                    <div class="col-lg-10 col-lg-offset-1">
                        ...
                        <h2 style="color: #000000;font-weight: 900;">Edit FAQ Item <!-- , <span style="font-weight: 100;">Here are your Loans --></h2>
                    </div>
                </div>
                    ...
                    <div class="col-lg-10 col-lg-offset-1">
                        <div class="row gutter-xs">
                            <div class="col-lg-6 col-md-6">
                                <button type="button" class="btn btn-success" ><a href="{{route('users.cms.add_faq')}}" style="color: #fff;" >Create faq item</a></button>
                            </div>
<!--                             <div class="col-lg-6">
                            ...
                            <div class="col-lg-12">
                                <table class="table table-hover table-borderless" style="background-color: #e0e0e0;">
                                    ...
                                    <tr class="white-rows">
                                        ...
                                        <td class="text-left"><b>{{$ldata->type}}</b></td>
                                        <td class="text-left"><b>{{$ldata->title}}</b></td>
                                        <td class="text-left">{{ substr($ldata->text, 0, 50)}}</td>                                       
                                    ...
                                    <td style="padding: 0;" colspan="7">
                                        <div id="detail{{$ldata->id}}" class="collapse">
                                            <div class="card">
                                                <div class="card-body">
                                                    <div class="row">
                                                        <form action="{{ route('users.cms.faq_update') }}" method="post" enctype="multipart/form-data">
                                                            @csrf

                                                            <div class="col-lg-10 col-md-10">

                                                              <div class="form-group col-md-4">
                                                                    <label for="title" class="text-dark">Type</label>

                                                                    <input id="type" type="text" class="form-control @error('title') is-invalid @enderror" name="type" value="{{ $ldata->type }}" required autocomplete="title">
                                                              ...
                                                              <div class="form-group col-md-4">
                                                                ...
                                                                <div class="form-group col-md-4">
                                                                    <label for="email" class="text-dark">Text</label>
                                                                    <textarea  style="height: 200px;" class="form-control" id="text" placeholder="Another input" name="text">{{ $ldata->text}} </textarea>
                                                                    @error('text')
                                                                    <span class="invalid-feedback" role="alert">
                                                                        <strong>{{ $message }}</strong>
                                                                    </span>
                                                            ...
                                                            <div class="col-lg-2 col-md-2">
                                                                <button type="button" class="btn btn-danger" style="width: 100%; margin: 25px 0 15px 0;" data-toggle="modal" href=""><a href="{{ url('admin/cms/delete_faq') }}<?php echo "?id=".$ldata->id ?>" style="color: #fff;" >Delete item</a></button>
