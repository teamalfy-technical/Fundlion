            ...
            <div class="layout-content-body container" style="background-color: #e0e0e0;font-weight: 700; min-height:100vh;">
                ...
                <div class="row ">
                    <div class="col-lg-6 col-lg-offset-1">
                        ...
                        <form action="{{route('users.cms.get_started_update')}}" method="post" role="form" enctype="multipart/form-data">
                         @csrf
...
<!--                                 <input type="text" class="form-control" id="formGroupExampleInput" placeholder="Example input" value="{{ $data->text}}" name="text" required=""> -->

                                <textarea class="form-control" id="formGroupExampleInput2" placeholder="Another input" name="text" style="height: 100px;"> {{ $data->text}}</textarea>                                
                            </div>
