            ...
            <div class="layout-content-body container" style="background-color: #e0e0e0;font-weight: 700; min-height:100vh;">
                ...
                <div class="row ">
                    <div class="col-lg-6 col-lg-offset-1">
                        ...
                        <form action="{{route('users.cms.homepage_update')}}" method="post" role="form" enctype="multipart/form-data">
                         @csrf
                            <div class="form-group">
                                <label for="formGroupExampleInput">Banner</label>
                                <!-- <div class="img-picker"></div> -->
<input type="file" name="banner_pic" id="input-file-now-custom-1" class="dropify" data-default-file="{{asset("storage/app/cms/$data->banner_pic")}}" />                                
                            </div>
                            <div class="form-group">
                                <label for="formGroupExampleInput">Banner Heading</label>
                                <input type="text" class="form-control" id="formGroupExampleInput" placeholder="Example input" value="{{ $data->banner_title}}" name="banner_title" required="">
                            </div>
                            <div class="form-group">
                                <label for="formGroupExampleInput2">Banner Text</label>
                                <input type="text" class="form-control" id="formGroupExampleInput2" placeholder="Another input" value="{{ $data->banner_text}}" name="banner_text" required="">
                            </div>
