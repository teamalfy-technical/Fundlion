            ...
            <div class="layout-content-body container" style="background-color: #e0e0e0;font-weight: 700; min-height:100vh;">
                ...
                <div class="row ">
                    <div class="col-lg-6 col-lg-offset-1">
                        ...
                        <form action="{{route('users.cms.how_it_works_update')}}" method="post" role="form" enctype="multipart/form-data">
                         @csrf
                            <div class="form-group">
                                <label for="formGroupExampleInput2">Image</label>
                                <input type="file"      name="image" id="input-file-now-custom-1" class="dropify" data-default-file="{{asset("storage/app/cms/$data->image")}}" /> 
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="formGroupExampleInput" placeholder="Example input" value="{{ $data->step_1_title}}" name="step_1_title">
                            </div>

                            <div class="form-group">
                                <label for="formGroupExampleInput2">Text</label>
                                <textarea  style="height: 200px;" class="form-control" id="formGroupExampleInput2" placeholder="Another input" name="step_1_text">{{ $data->step_1_text}}</textarea>
                            </div>

                            <h3>Step 2</h3>
                            <div class="form-group">
                                <label for="formGroupExampleInput">Title</label>
                                <input type="text" class="form-control" id="formGroupExampleInput" placeholder="Example input" value="{{ $data->step_2_title}}" name="step_2_title">
                            </div>

                            <div class="form-group">
                                <label for="formGroupExampleInput2">Text</label>
                                <textarea  style="height: 200px;" class="form-control" id="formGroupExampleInput2" placeholder="Another input" name="step_2_text">{{ $data->step_2_text}}</textarea>
                            </div>
                            ...
                            <div class="form-group">
                                <label for="formGroupExampleInput">Title</label>
                                <input type="text" class="form-control" id="formGroupExampleInput" placeholder="Example input" value="{{ $data->step_3_title}}" name="step_3_title">
                            </div>

                            <div class="form-group">
                                <label for="formGroupExampleInput2">Text</label>
                                <textarea  style="height: 200px;" class="form-control" id="formGroupExampleInput2" placeholder="Another input"  name="step_3_text">{{ $data->step_3_text}}</textarea>
                            </div>
