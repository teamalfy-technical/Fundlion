            ...
            <div class="layout-content-body" style="background-color: #e0e0e0;font-weight: 700;height: unset;">
                ...
                <div class="row gutter-xs">
                    <div class="col-lg-10 col-lg-offset-1">
                        ...
                        <h2 style="color: #000000;font-weight: 900;">Edit Loan Items <!-- , <span style="font-weight: 100;">Here are your Loans --></h2>
                    </div>
                </div>
                    ...
                    <div class="col-lg-10 col-lg-offset-1">
                        <div class="row gutter-xs">
                            <div class="col-lg-6 col-md-6">
                                <button type="button" class="btn btn-success" ><a href="{{route('users.cms.new_loan')}}" style="color: #fff;" >Create New item</a></button>
                            </div>
<!--                             <div class="col-lg-6">
                            ...
                            <div class="col-lg-12">
                                <table class="table table-hover table-borderless" style="background-color: #e0e0e0;">
                                    ...
                                    <tr class="white-rows">
                                        ...
                                        <td class="text-left">{{ substr($ldata->description, 0, 50)}}</td>
                                        <td class="text-left">{{$ldata->type}}</td>
                                    ...
                                    <td style="padding: 0;" colspan="7">
                                        <div id="detail{{$ldata->id}}" class="collapse">
                                            <div class="card">
                                                <div class="card-body">
                                                    <div class="row">
                                                        <form action="{{ route('users.cms.loans_update',$ldata->id) }}" method="post" enctype="multipart/form-data">
                                                            @csrf
...
<!--                                                                     @error('image')
                                                                ...
                                                                <div class="form-group col-md-4">
                                                                    ...
                                                                    <textarea  style="height: 200px;" class="form-control" id="description" placeholder="Another input" name="description">{{ $ldata->description}} </textarea>
                                                                    @error('description')
                                                                    <span class="invalid-feedback" role="alert">
                                                                        <strong>{{ $message }}</strong>
                                                                    </span>
                                                                ...
                                                                <div class="form-group col-md-4">
                                                                    ...
                                                                    <input id="type" type="text" class="form-control @error('title') is-invalid @enderror" name="type" value="{{ $ldata->type }}" required autocomplete="type">
                                                            ...
                                                            <div class="col-lg-2 col-md-2">
                                                                <button type="button" class="btn btn-danger" style="width: 100%; margin: 25px 0 15px 0;" data-toggle="modal" href=""><a href="{{ url('admin/cms/delete_loan') }}<?php echo "?id=".$ldata->id ?>" style="color: #fff;" >Delete loan item</a></button>
