    ...
    <link rel="stylesheet" href="{{asset('public/pages/assets/lightbox/css/lightbox.css')}}">
    <link rel="stylesheet" href="{{asset('public/pages/assets/css/style4.css')}}">
    <!-- Dropzone css -->
    ...
    <link rel="stylesheet" href="{{asset('public/pages/assets/ckeditor/samples/css/samples.css')}}">
    
    <link rel="stylesheet" href="{{asset('public/pages/assets/ckeditor/samples/toolbarconfigurator/lib/codemirror/neo.css')}}">
